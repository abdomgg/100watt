...
class ResPartner(models.Model):
    ...
    def action_print_customer_statement_pdf(self):
        self.ensure_one()
        return self.env.ref('nx_100_customer_statement.action_report_customer_statement_pdf').report_action(self)
    ...
    def action_print_customer_statement_excel(self):
        ...
        try:
            ...
            headers = ['Invoice Date', 'Invoice No.', 'Due Date', 'Total Amount', 'Amount Due', 'Balance']
            ...
            raise UserError('xlsxwriter library is not installed. Please install it to use Excel export.')
